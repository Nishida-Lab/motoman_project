...
int main(int argc, char **argv)
{
  ...
  // Create Octomap Service Client
  ros::ServiceClient oct_srv_client = nh.serviceClient<std_srvs::Empty>(move_group::CLEAR_OCTOMAP_SERVICE_NAME);
  std_srvs::Empty srv;
  ...
  // Octomap Clear
  if(oct_srv_client.call(srv))
	std::cout << "Cleared Octomap !" << std::endl;
