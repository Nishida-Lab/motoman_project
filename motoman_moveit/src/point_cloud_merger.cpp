...
void PointCloudMerger::callback(const sensor_msgs::PointCloud2::ConstPtr &msg1,const sensor_msgs::PointCloud2::ConstPtr &msg2) {
  ...
  listener.waitForTransform(msg2->header.frame_id, msg1->header.frame_id,
                            msg1->header.stamp, ros::Duration(1.0));
  pcl_ros::transformPointCloud(msg2->header.frame_id, *msg1, cloud_transformed,
                               listener);
